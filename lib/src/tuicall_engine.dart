...
import 'package:tencent_calls_engine/src/tuicall_callback.dart';
import 'package:tencent_calls_engine/src/tuicall_define.dart';
import 'package:tencent_calls_engine/src/tuicall_observer.dart';
import 'package:tencent_calls_engine/src/utils.dart';
...
class TUICallEngine extends PlatformInterface {
  ...
  /// @param succ Inquiry results of successful results
  /// return TUIResult
  Future<void> queryRecentCalls(
      TUICallRecentCallsFilter filter, TUIValueCallback callback) async {
    return await TUICallEnginePlatform.instance
        .queryRecentCalls(filter, callback);
  }

  /// Delete call records
  ///
  /// @param callIdList Callid list to be deleted
  /// @param succ Delete the successful callid list
  /// return TUIResult
  Future<void> deleteRecordCalls(
      List<String> callIdList, TUIValueCallback callback) async {
    return await TUICallEnginePlatform.instance
        .deleteRecordCalls(callIdList, callback);
  }
